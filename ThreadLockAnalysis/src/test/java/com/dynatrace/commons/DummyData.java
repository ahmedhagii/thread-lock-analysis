...
public class DummyData {
    ...
    public static final String THREAD_3_STACK_TRACE =
            "at sun.misc.Unsafe.park(Native Method)###$$###" +
            "- parking to wait for  <0x00000007b0bb10c0> (a java.util.concurrent.locks.AbstractQueuedSynchronizer$ConditionObject)###$$###" +
            "at java.util.concurrent.locks.LockSupport.park(LockSupport.java:175)###$$###" +
            "at java.util.concurrent.locks.AbstractQueuedSynchronizer$ConditionObject.await(AbstractQueuedSynchronizer.java:2039)###$$###" +
            ...
            "at java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:617)###$$###" +
            "at java.lang.Thread.run(Thread.java:748)";
    public static final String THREAD_1_STACK_TRACE =
            "at java.lang.Object.wait(Native Method)###$$###" +
            "at org.openide.util.RequestProcessor$Processor.run(RequestProcessor.java:2002)###$$###" +
            "- locked <0x00000007b16ac640> (a java.lang.Object)";
    public static final String THREAD_2_STACK_TRACE = "";

    public static final String TIMESTAMP = "1516309321278";

    public static final String THREAD_1_CSV = "0x00007ffa01667800,Inactive RequestProcessor thread [Was:ThreadsWorker/com.sun.tools.visualvm.application.views.threads.ApplicationThreadsView$MasterViewSupport$3],1,TIMED_WAITING,"
            + TIMESTAMP + "," + THREAD_1_STACK_TRACE;
